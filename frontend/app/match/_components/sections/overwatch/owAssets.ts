// Assets Overwatch statiques. Screenshots de maps servis par OverFast API
// (overfast-api.tekrop.fr/static/maps, hotlink libre) ; portraits de héros sur
// le CDN Blizzard (d15f34w2p8l1cc.cloudfront.net). Mapping nom → asset ; null
// si inconnu → fallback dégradé navy côté composant. Source : OverFast API
// (/maps expose aussi le gamemode, seule donnée factuelle du mode de jeu).

// Les noms Liquipedia varient sur la casse/accents/apostrophes (Lúcio, Torbjörn,
// King's Row vs King’s Row) → clé normalisée sans diacritiques ni ponctuation.
...
// [screenshotUrl, gamemode] par map normalisée.
const MAPS: Record<string, [string, string]> = {
  aatlis: ['https://overfast-api.tekrop.fr/static/maps/aatlis.jpg', 'flashpoint'],
  antarcticpeninsula: ['https://overfast-api.tekrop.fr/static/maps/antarctic-peninsula.jpg', 'control'],
  arenavictoriae: ['https://overfast-api.tekrop.fr/static/maps/arena-victoriae.jpg', 'control'],
  ayutthaya: ['https://overfast-api.tekrop.fr/static/maps/ayutthaya.jpg', 'capture-the-flag'],
  blackforest: ['https://overfast-api.tekrop.fr/static/maps/black-forest.jpg', 'elimination'],
  blizzardworld: ['https://overfast-api.tekrop.fr/static/maps/blizzard-world.jpg', 'hybrid'],
  busan: ['https://overfast-api.tekrop.fr/static/maps/busan.jpg', 'control'],
  castillo: ['https://overfast-api.tekrop.fr/static/maps/castillo.jpg', 'elimination'],
  chateauguillard: ['https://overfast-api.tekrop.fr/static/maps/chateau-guillard.jpg', 'deathmatch'],
  circuitroyal: ['https://overfast-api.tekrop.fr/static/maps/circuit-royal.jpg', 'escort'],
  colosseo: ['https://overfast-api.tekrop.fr/static/maps/colosseo.jpg', 'push'],
  dorado: ['https://overfast-api.tekrop.fr/static/maps/dorado.jpg', 'escort'],
  ecopointantarctica: ['https://overfast-api.tekrop.fr/static/maps/ecopoint-antarctica.jpg', 'elimination'],
  eichenwalde: ['https://overfast-api.tekrop.fr/static/maps/eichenwalde.jpg', 'hybrid'],
  esperanca: ['https://overfast-api.tekrop.fr/static/maps/esperanca.jpg', 'push'],
  gogadoro: ['https://overfast-api.tekrop.fr/static/maps/gogadoro.jpg', 'control'],
  hanamura: ['https://overfast-api.tekrop.fr/static/maps/hanamura.jpg', 'assault'],
  hanaoka: ['https://overfast-api.tekrop.fr/static/maps/hanaoka.jpg', 'clash'],
  havana: ['https://overfast-api.tekrop.fr/static/maps/havana.jpg', 'escort'],
  hollywood: ['https://overfast-api.tekrop.fr/static/maps/hollywood.jpg', 'hybrid'],
  horizonlunarcolony: ['https://overfast-api.tekrop.fr/static/maps/horizon.jpg', 'assault'],
  ilios: ['https://overfast-api.tekrop.fr/static/maps/ilios.jpg', 'control'],
  junkertown: ['https://overfast-api.tekrop.fr/static/maps/junkertown.jpg', 'escort'],
  kanezaka: ['https://overfast-api.tekrop.fr/static/maps/kanezaka.jpg', 'deathmatch'],
  kingsrow: ['https://overfast-api.tekrop.fr/static/maps/kings-row.jpg', 'hybrid'],
  lijiangtower: ['https://overfast-api.tekrop.fr/static/maps/lijiang-tower.jpg', 'control'],
  malevento: ['https://overfast-api.tekrop.fr/static/maps/malevento.jpg', 'deathmatch'],
  midtown: ['https://overfast-api.tekrop.fr/static/maps/midtown.jpg', 'hybrid'],
  necropolis: ['https://overfast-api.tekrop.fr/static/maps/necropolis.jpg', 'elimination'],
  nepal: ['https://overfast-api.tekrop.fr/static/maps/nepal.jpg', 'control'],
  newjunkcity: ['https://overfast-api.tekrop.fr/static/maps/new-junk-city.jpg', 'flashpoint'],
  newqueenstreet: ['https://overfast-api.tekrop.fr/static/maps/new-queen-street.jpg', 'push'],
  numbani: ['https://overfast-api.tekrop.fr/static/maps/numbani.jpg', 'hybrid'],
  oasis: ['https://overfast-api.tekrop.fr/static/maps/oasis.jpg', 'control'],
  paraiso: ['https://overfast-api.tekrop.fr/static/maps/paraiso.jpg', 'hybrid'],
  paris: ['https://overfast-api.tekrop.fr/static/maps/paris.jpg', 'assault'],
  petra: ['https://overfast-api.tekrop.fr/static/maps/petra.jpg', 'deathmatch'],
  placelacroix: ['https://overfast-api.tekrop.fr/static/maps/place-lacroix.jpg', 'push'],
  powderkegmine: ['https://overfast-api.tekrop.fr/static/maps/powder-keg-mine.jpg', 'payload-race'],
  redwooddam: ['https://overfast-api.tekrop.fr/static/maps/redwood-dam.jpg', 'push'],
  rialto: ['https://overfast-api.tekrop.fr/static/maps/rialto.jpg', 'escort'],
  route66: ['https://overfast-api.tekrop.fr/static/maps/route-66.jpg', 'escort'],
  runasapi: ['https://overfast-api.tekrop.fr/static/maps/runasapi.jpg', 'push'],
  samoa: ['https://overfast-api.tekrop.fr/static/maps/samoa.jpg', 'control'],
  shambalimonastery: ['https://overfast-api.tekrop.fr/static/maps/shambali-monastery.jpg', 'escort'],
  suravasa: ['https://overfast-api.tekrop.fr/static/maps/suravasa.jpg', 'flashpoint'],
  templeofanubis: ['https://overfast-api.tekrop.fr/static/maps/anubis.jpg', 'assault'],
  thamesdistrict: ['https://overfast-api.tekrop.fr/static/maps/thames-district.jpg', 'payload-race'],
  throneofanubis: ['https://overfast-api.tekrop.fr/static/maps/throne-of-anubis.jpg', 'clash'],
  volskayaindustries: ['https://overfast-api.tekrop.fr/static/maps/volskaya.jpg', 'assault'],
  watchpointgibraltar: ['https://overfast-api.tekrop.fr/static/maps/watchpoint-gibraltar.jpg', 'escort'],
  wuxinguniversity: ['https://overfast-api.tekrop.fr/static/maps/wuxing-university.jpg', 'control'],
};

// Libellés courts de mode (terminologie de jeu, EN par défaut). Fallback :
// libellé brut nettoyé.
...
/** Screenshot large d'une map Overwatch, ou null si le nom est inconnu. */
export function owMapImage(name?: string | null): string | null {
  if (!name) return null;
  return MAPS[normalize(name)]?.[0] ?? null;
}

/** Libellé du mode de jeu d'une map (Control, Escort...), ou null si inconnu. */
export function owMapMode(name?: string | null): string | null {
  if (!name) return null;
  const mode = MAPS[normalize(name)]?.[1];
  if (!mode) return null;
  return MODE_LABELS[mode] ?? mode.replace(/-/g, ' ').replace(/\b\w/g, c => c.toUpperCase());
}
...
const HEROES: Record<string, string> = {
  ...
  jetpackcat: 'https://d15f34w2p8l1cc.cloudfront.net/overwatch/03a184cd0de27091e0099ac22635ad9615a8f6997881a5c25cc5f2444764f729.png',
  junkerqueen: 'https://d15f34w2p8l1cc.cloudfront.net/overwatch/06eeecb359f311f43a8f5121d4f9f3a93c565d70b30e94ef543c05596c9a39dc.png',
...
/** Portrait carré d'un héros Overwatch, ou null si le nom est inconnu. */
export function owHeroPortrait(name?: string | null): string | null {
  if (!name) return null;
  return HEROES[normalize(name)] ?? null;
}
