          ...
          <section>
            ...
            <div className="bg-[#091626] border border-[#182859]/30 rounded-lg p-6 space-y-3">
              ...
              <div>
                ...
                <ul className="list-disc list-inside ml-2 space-y-1">
                  <li><strong className="text-white">Liquipedia :</strong> Fournit les données de tournois, matchs, équipes et matchs en direct (aucune donnée utilisateur partagée)</li>
                </ul>
              </div>
