// Pure draft parsing (picks + bans per team), ported verbatim from the web
// match detail. No JSX — shared by every per-game card. Two wiki formats are
// handled: aggregated lists (team1bans) and numbered keys (team1ban1..5 for
// LoL / Dota2).
