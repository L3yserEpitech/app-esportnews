...
```env
# App ID iOS
ADMOB_IOS_APP_ID=ca-app-pub-4019532498018851~9375398922

# App ID Android
ADMOB_ANDROID_APP_ID=ca-app-pub-4019532498018851~8443596219

# Ad Unit IDs - Interstitiel (PAR PLATEFORME)
ADMOB_IOS_INTERSTITIAL_ID=ca-app-pub-4019532498018851/1689083231
ADMOB_ANDROID_INTERSTITIAL_ID=ca-app-pub-4019532498018851/4650288493
```
