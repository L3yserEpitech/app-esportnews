...
import 'match_live_component_model.dart';
export 'match_live_component_model.dart';

class MatchLiveComponentWidget extends StatefulWidget {
  const MatchLiveComponentWidget({super.key});

  @override
  State<MatchLiveComponentWidget> createState() =>
      _MatchLiveComponentWidgetState();
}

class _MatchLiveComponentWidgetState extends State<MatchLiveComponentWidget>
    with TickerProviderStateMixin {
  late MatchLiveComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MatchLiveComponentModel());
