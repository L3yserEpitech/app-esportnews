...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    esportNewsAuthUserSubject.add(
      EsportNewsAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<EsportNewsAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  EsportNewsAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = EsportNewsAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    esportNewsAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
EsportNewsAuthUser? currentUser;
